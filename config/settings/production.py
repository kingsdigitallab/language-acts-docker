...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["language_acts.info"])
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Language Acts <noreply@language_acts.info>",
)
# https://docs.djangoproject.com/en/dev/ref/settings/#server-email
SERVER_EMAIL = env("DJANGO_SERVER_EMAIL", default=DEFAULT_FROM_EMAIL)
# https://docs.djangoproject.com/en/dev/ref/settings/#email-subject-prefix
EMAIL_SUBJECT_PREFIX = env(
    "DJANGO_EMAIL_SUBJECT_PREFIX", default="[Language Acts]"
)
...
ANYMAIL = {
    "MAILGUN_API_KEY": env("MAILGUN_API_KEY", default="000000"),
    "MAILGUN_SENDER_DOMAIN": env("MAILGUN_DOMAIN", default="localhost"),
