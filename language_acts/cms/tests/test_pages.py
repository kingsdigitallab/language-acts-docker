...
import factory
from language_acts.cms.models.pages import _paginate
from language_acts.cms.models import (
    BlogIndexPage, EventIndexPage, HomePage, OwriIndexPage, NewsIndexPage,
    PastEventIndexPage, OwriRichTextPage, StrandPage, TagResults,
...
class TestIndexPage(WagtailPageTests):
    ...
    def test_subpage_types(self):
        self.assertAllowedSubpageTypes(
            OwriIndexPage, {OwriIndexPage, OwriRichTextPage})
...
class TestRichTextPage(WagtailPageTests):
    ...
    def test_subpage_types(self):
        self.assertAllowedSubpageTypes(OwriRichTextPage, {})
